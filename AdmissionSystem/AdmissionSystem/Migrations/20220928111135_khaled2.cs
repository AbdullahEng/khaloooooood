...
{
    public partial class khaled2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TheIDnumber = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    The_ID_Number = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UnvirstyId = table.Column<double>(nullable: true),
                    Conformation = table.Column<int>(nullable: false),
                    ...
                    Identity_No = table.Column<string>(nullable: true),
                    ...
                    Home_s_Phone = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    loack = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Employee",
                columns: new[] { "id", "Birth", "Email", "Gender", "Nick_Name", "Phone_Number", "The_ID_Number", "Type", "name" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "useer1@localhost", "Male", "adm", "0987", "8765", "Admin", "Admin1" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "useer2@localhost", "Male", "adm", "0987", "8765", "Admin", "Admin2" }
                });
